...
#include "common.h"
#include "compat.h"
#include "amdgpu/common_baco.h" // Added this include to fix the missing function declaration
...
static int vega10_baco_set_state(struct amd_fake_dev *adev, enum BACO_STATE state)
{
...
static int amd_barcelo_reset(struct vendor_reset_dev *dev)
{
...
const struct vendor_reset_ops amd_barcelo_ops = {
    .version = {1, 0},
    .probe = amd_common_probe,
    .pre_reset = amd_common_pre_reset,
    .reset = amd_barcelo_reset,
